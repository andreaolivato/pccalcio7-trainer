...
namespace PcCalcio7Trainer.Translations
{
    internal static class Es
    {
        ...
        public static readonly Dictionary<string, string> Text = new Dictionary<string, string>
        {
            ...
            { "capHint", "Registro del club escrito: el motor lo usa desde la próxima jornada (mira el % de asistencia). La pantalla Estadio puede seguir mostrando la cifra vieja: se calcula desde los sectores, aún sin descodificar." },
